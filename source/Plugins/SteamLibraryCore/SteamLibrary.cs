...
namespace SteamLibrary
{
    public class SteamLibrary : LibraryPlugin
    {
        ...
        public void ImportSteamLastActivity(ulong accountId)
        {
            ...
            if (accountId == 0)
            {
                logger.Error(resources.GetString("LOCImportError"));
                logger.Error(resources.GetString("LOCSettingsSteamLastActivityImportErrorAccount"));
                return;
            }
            ...
            {
                logger.Error(resources.GetString("LOCImportError"));
                logger.Error(resources.GetString("LOCSettingsSteamLastActivityImportErrorDb"));
                return;
            }
            ...
            try
            {
                ...
                logger.Info(resources.GetString("LOCImportCompleted"));
            }
            catch (Exception exc) when (!Environment.IsDebugBuild)
            {
                logger.Error(exc, "Failed to import Steam last activity.");
                logger.Error(resources.GetString("LOCImportError"));
                logger.Error(resources.GetString("LOCSettingsSteamLastActivityImportError"));
            }
        }
        ...
        public void ImportSteamCategories(ulong accountId)
        {
            ...
            logger.Error(resources.GetString("LOCImportError"));
            logger.Warn(resources.GetString("LOCSettingsSteamCatImportWarnTitle"));
            logger.Warn("continuing");

            if (accountId == 0)
            {
                logger.Error(resources.GetString("LOCImportError"));
                logger.Error(resources.GetString("LOCSettingsSteamCatImportErrorAccount"));
                return;
            }
            ...
            {
                logger.Error(resources.GetString("LOCImportError"));
                logger.Error(resources.GetString("LOCSettingsSteamCatImportErrorDb"));
                return;
            }
            ...
            catch (Exception exc) when (!Environment.IsDebugBuild)
            {
                ...
                logger.Error(resources.GetString("LOCImportError"));
                logger.Error(resources.GetString("LOCSettingsSteamCatImportError"));
            }
        }
